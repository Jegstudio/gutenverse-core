...
class Options {
	...
	private function set_default_image_load() {
		if ( isset( $this->options['frontend_settings']['default_image_load'] ) ) {
			$default_image_load = $this->options['frontend_settings']['default_image_load'];
