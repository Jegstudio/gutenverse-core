...
class Post_Date extends Block_Abstract {
	...
	public function render_frontend() {
		...
		return '<div class="' . $element_id . $display_classes . $animation_class . $transform_class . $custom_classes . ' guten-post-date guten-element">' . $this->render_content( $post_id ) . '</div>';
	}
}
