...
import { shapeDividerLoader } from '../../../data/shape-divider-animated';
...
export const SectionDividerAnimatedTop = ({ attributes }) => {
    ...
    if (type && type !== 'none') {
        divider = shapeDividerLoader(topDividerAnimated);
    }
...
export const SectionDividerAnimatedBottom = ({ attributes }) => {
    ...
    if (type && type !== 'none') {
        divider = shapeDividerLoader(bottomDividerAnimated);
    }
