...
const SectionVariationPicker = ({onSelect}) => {
    ...
    const ResetColumn = (
        <div className={'reset-column'} onClick={() => setColumn(0)}>
            <span>
                <ChevronLeft height={18} width={12}/> {__('Back', 'gutenverse')}
            </span>
        </div>
    );
    ...
    if (column === 0) {
        choose = <>
            <h3 className="select-column-variation">{__('Select Column', 'gutenverse')}</h3>
            <ul className="section-variation-picker-list" aria-label={__('Section variations', 'gutenverse')}>
                <VariationList
                    icon={column1_100}
                    onClick={() => onSelect(col1_100)}
                    label={__('1 Column', 'gutenverse')}
                />
                <VariationList
                    icon={column2_50_50}
                    onClick={() => setColumn(2)}
                    label={__('2 Column', 'gutenverse')}
                />
                <VariationList
                    icon={column3_33_33_33}
                    onClick={() => setColumn(3)}
                    label={__('3 Column', 'gutenverse')}
                />
                <VariationList
                    icon={column4_25_25_25_25}
                    onClick={() => onSelect(col4_25_25_25_25)}
                    label={__('4 Column', 'gutenverse')}
                />
                <VariationList
                    icon={column5_20_20_20_20_20}
                    onClick={() => onSelect(col5_20_20_20_20_20)}
                    label={__('5 Column', 'gutenverse')}
                />
            </ul>
        </>;
    } else if (column === 2) {
        choose = <>
            <h3 className="select-column-variation">{__(' 2 Column', 'gutenverse')}</h3>
            <ul className="section-variation-picker-list" aria-label={__('Section variations', 'gutenverse')}>
                <VariationList
                    icon={column2_50_50}
                    onClick={() => onSelect(col2_50_50)}
                    label={__('50 / 50', 'gutenverse')}
                />
                <VariationList
                    icon={column2_66_33}
                    onClick={() => onSelect(col2_66_33)}
                    label={__('66 / 33', 'gutenverse')}
                />
                <VariationList
                    icon={column2_33_66}
                    onClick={() => onSelect(col2_33_66)}
                    label={__('33 / 66', 'gutenverse')}
                />
            </ul>
            {ResetColumn}
        </>;
