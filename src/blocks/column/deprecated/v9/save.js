...
const save = compose(
    ...
    // Legacy: isCanSticky does not check isAlignStickyColumn to handle old blocks
    // where sectionVerticalAlign was not stored as a block attribute.
    const isCanSticky = isSticky(sticky);
