...
const ControlImageRadio = (props) => {
    ...
    return <div className="control-wrapper control-image-radio" style={(perRow ? { '--gutenverse-dashboard-img-radio-row': `calc(100% / ${perRow} - 10px)`, '--gutenverse-dashboard-img-radio-image-width': '100%' } : {})}>
