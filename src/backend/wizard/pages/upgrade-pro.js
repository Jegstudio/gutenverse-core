...
export const UpgradePro = ({ updateProgress }) => {
    // const { images, upgradePro } = window['GutenverseCompanionConfig'];
    ...
    return <div className="upgrade-pro-wrapper">
        ...
        <div className="upgrade-pro-actions">
            ...
            <div onClick={() => updateProgress('done', 1)} className="button-next">{__('Next', 'gutenverse')}</div>
        </div>
    </div>;
};