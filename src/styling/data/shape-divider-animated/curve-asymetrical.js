...
export const ShapeDivCurveAsymetrical = (props) => {
    const {
        colorMode,
        color0,
        color1,
                ...
                shapes: [
                    {
                        ...
                        it: [
                            ...
                            colorObj0,
                            { ty: 'tr', p: { a: 0, k: [960.408, 228.265], ix: 2 }, a: { a: 0, k: [0, 0], ix: 1 }, s: { a: 0, k: [100.238, 100], ix: 3 }, r: { a: 0, k: 0, ix: 6 }, o: { a: 0, k: 100, ix: 7 }, sk: { a: 0, k: 0, ix: 4 }, sa: { a: 0, k: 0, ix: 5 }, nm: 'Transform' },
                        ],
                        nm: 'Group 1',
                        np: 2,
                        cix: 2,
