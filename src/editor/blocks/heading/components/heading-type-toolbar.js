...
const HeadingLevelIcon = ( { level, isPressed = false } ) => {
    return (
        <SVG
            ...
            isPressed={ isPressed }
        >
            <Path d={ HEADING_ICONS[ level ] } />
        </SVG>
    );
};

const HeadingTypeToolbar = ({ type, onChange }) => {
    return (
        <Dropdown
            ...
            renderToggle={ ( { onToggle, isOpen } ) => {
                ...
                return (
                    <ToolbarButton
                        ...
                        aria-haspopup="true"
                        icon={ <HeadingLevelIcon level={ type } /> }
            ...
            renderContent={ () => (
                ...
                >
                    <ToolbarGroup
                        isCollapsed={ false }
                        controls={ HEADING_LEVELS.map( ( targetType ) => {
...
export default HeadingTypeToolbar;