    ...
    return <div id="gutenverse-warn">
        <div className="gutenverse-editor-warn">
            <div className="gutenverse-warn-wrapper post-content">
                ...
                <h3>{__('Gutenverse Post Content is Locked', 'gutenverse')}</h3>
                <p>{__('On "Show Template" mode, Gutenverse Post Content cannot be edited. Please switch to Content Editing mode to edit the content.', 'gutenverse')}</p>
                <button className="primary" onClick={editContent}>{__('Switch Mode', 'gutenverse')}</button>
            </div>
        </div>
    </div>;
};
