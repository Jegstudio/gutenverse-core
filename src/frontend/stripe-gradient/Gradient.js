...
class Gradient {
    ...
    constructor(options) {
        ...
        const canvasOption = this.getOption('canvas');
        const canvas = this.findCanvas(canvasOption);
        this.setCanvas(canvas);

        // Bail if no canvas element.
        if (!this.getCanvas()) {
            console.error('Missing Canvas. Pass the canvas to the Gradient constructor.');
        } else {
