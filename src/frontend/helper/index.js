...
export const reinitMap = {
    ...
    GutenverseFormValidation: '.guten-form-builder',
    GutenverseInputDate: '.guten-form-input-date',
    GutenverseInputGDPR: '.guten-form-input-gdpr',
    GutenverseMultiInputSelect: '.guten-form-input-multiselect',
    GutenverseInputRadio: '.guten-form-input-radio',
    GutenverseInputSelect: '.guten-form-input-select',
