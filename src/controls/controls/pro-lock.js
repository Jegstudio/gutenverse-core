                ...
                <div className="popup-body" ref={popupRef}>
                    ...
                    <div className="more-details">
                        <div className="more-detail">
                            ...
                            <a href={proUrl} target="_blank" rel="noreferrer">{__('View Demo', '--gctd--')}</a>
                        </div>
                        <div className="more-detail">
                            ...
                            <a href={proUrl} target="_blank" rel="noreferrer">{__('Documentation', '--gctd--')}</a>
                        </div>
                    </div>
                </div>
            </div>}
