    ...
    return <>
        <div className={'control-locked'}>
            <p className="label" onClick={() => setPopup(true)}>
                <strong>{__('PRO', 'gutenverse')}</strong>
            ...
            {popup && <div className={'control-locked-popup'}>
                <div className="popup-body" ref={popupRef}>
                    ...
                    <h2 className="title">{__('Popup Title', 'gutenverse')}</h2>
                    <div>
                        <div className="gutenverse-button" onClick={openLink}><IconCrownSVG /> Available in Pro Version</div>
                    </div>
                    <div>
                        <p className="description">{__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse congue justo nec dui bibendum, nec viverra libero venenatis. Proin sollicitudin tincidunt erat, ut aliquam tellus dignissim nec. Donec porttitor quis velit nec hendrerit. Aliquam erat volutpat. Morbi bibendum neque ac maximus viverra.')}</p>
                    </div>
                    <div>
                    ...
                    <div className="more-details">
                        <div className="more-detail">
                            ...
                            <a href={proUrl} target="_blank" rel="noreferrer">{__('View Demo', 'gutenverse')}</a>
                        </div>
                        <div className="more-detail">
                            ...
                            <a href={proUrl} target="_blank" rel="noreferrer">{__('Documentation', 'gutenverse')}</a>
                        </div>
                    </div>
                </div>
            </div>}
