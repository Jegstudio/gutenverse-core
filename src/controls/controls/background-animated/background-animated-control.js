...
import { IconDimensionXSVG, IconDimensionYSVG, IconDimensionZSVG, IconChevronSVG } from 'gutenverse-core/icons';// import Select from 'react-select';
import classnames from 'classnames';
import ControlHeadingSimple from '../part/control-heading-simple';
import cryptoRandomString from 'crypto-random-string';
import { customBackgroundScrolling } from 'gutenverse-core/animation';
...
const ActionItem = ({
    ...
    const customOptions = customBackgroundScrolling();
...
const backgroundAnimatedOption = ({ id, value, onValueChange, onStyleChange, elementRef, customOptions }) => {
...
const BackgroundAnimatedControl = (props) => {
    const {
        value = {},
        onValueChange,
        onStyleChange,
    ...
    const id = useInstanceId(BackgroundAnimatedControl, 'inspector-background-animated-control');
    const parameter = {
        id,
        value,
        onValueChange,
    ...
    return backgroundAnimatedOption(parameter);
};

export default BackgroundAnimatedControl;