...
const LockedNewsPaywallPackage = ({isOpen}) => {
    const id = useInstanceId(LockedNewsPaywallPackage, 'inspector-locked-news-view-counter');
...
export default LockedNewsPaywallPackage;