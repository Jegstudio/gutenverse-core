    ...
    return <div id={id} className={'gutenverse-control-wrapper gutenverse-control-locked gutenverse-control-locked-layout'}>
        ...
        <div>
            <div className="gutenverse-button activate" onClick={() => window.open(licenseUrl)}>
                <IconKeySVG fill={'white'}/> {__('Activate License', 'gutenverse-pro')}
            </div>
        </div>
        <div>
        ...
        <div className="more-details">
            <div className="more-detail">
                ...
                <a href={licenseUrl} target="_blank" rel="noreferrer">{__('How to activate license', 'gutenverse-pro')}</a>
            </div>
        </div>
    </div>;
};

export default LockedProPanel;