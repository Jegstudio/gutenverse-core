...
const LockedFormMultiGroupSelectPanel = ({isOpen}) => {
    const id = useInstanceId(LockedFormMultiGroupSelectPanel, 'inspector-locked-advance-tabs');
...
export default LockedFormMultiGroupSelectPanel;