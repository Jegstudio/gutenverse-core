...
export const IconKeySVG = ({fill='white'}) => {
    return <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill={fill}>
