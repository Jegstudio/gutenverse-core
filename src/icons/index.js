import LogoCircleColor16 from './logo/logo-circle-color-16.svg';
import LogoCircleColor20 from './logo/logo-circle-color-20.svg';
import LogoCircleColor24 from './logo/logo-circle-color-24.svg';
import LogoColor from './logo/logo-color.svg';
import LogoFullColor31 from './logo/logo-full-color-31.svg';
import LogoFullColor from './logo/logo-full-color.svg';
...
/* Dimension Icons */
import IconDimensionX from './icon/icon-dimension-x.svg';
...
import IconGlobe from './icon/icon-globe.svg';
import IconChevron from './icon/icon-chevron.svg';
import IconSearch from './icon/icon-search.svg';
import IconDeviceDesktop from './icon/icon-device-desktop.svg';
import IconDeviceTablet from './icon/icon-device-tablet.svg';
import IconDeviceMobile from './icon/icon-device-mobile.svg';
import IconInfo from './icon/icon-info.svg';
import IconInfoGray from './icon/icon-infogray.svg';
import IconInfoYellow from './icon/icon-infoyellow.svg';
import IconDocs from './icon/icon-docs.svg';
import IconSupport from './icon/icon-support.svg';
import IconCopy from './icon/icon-copy.svg';
import IconCheck from './icon/icon-check.svg';
import IconCheckCircle from './icon/icon-check-circle.svg';
import IconTimes from './icon/icon-times.svg';
import IconLove from './icon/icon-love.svg';
import IconLayouts from './icon/icon-layouts.svg';
import IconBlocks from './icon/icon-blocks.svg';
import IconToolbarColumnAdd from './icon/icon-toolbar-column-add.svg';
import IconToolbarColumnDelete from './icon/icon-toolbar-column-delete.svg';
...
/* Others */
import IconNoticeGutenverse from './icon/icon-notice-gutenverse.svg';
import IconNoticeWarning from './icon/icon-notice-warning.svg';
import IconNoticeBell from './icon/icon-notice-bell.svg';
...
export const LogoCircleColor20SVG = (props) => {
    return <LogoCircleColor20 {...props} />;
};

export const LogoCircleColor24SVG = (props) => {
    return <LogoCircleColor24 {...props} />;
};

export const LogoIconGutenverseSVG = (props) => {
    return <LogoIconGutenverse {...props} />;
};

export const LogoColorSVG = (props) => {
    return <LogoColor {...props} />;
};

export const LogoFullColor31SVG = (props) => {
    return <LogoFullColor31 {...props} />;
};

export const LogoFullColorSVG = (props) => {
...
export const LogoWhite24SVG = (props) => {
    return <LogoWhite24 {...props} />;
};

export const LogoWhiteSVG = (props) => {
    return <LogoWhite {...props} />;
};

export const IconDimensionXSVG = (props) => {
    return <IconDimensionX {...props} />;
};

export const IconDimensionYSVG = (props) => {
    return <IconDimensionY {...props} />;
};

export const IconDimensionZSVG = (props) => {
    return <IconDimensionZ {...props} />;
};

export const IconDuplicateSVG = (props) => {
    return <IconDuplicate {...props} />;
};

export const IconTypographySVG = (props) => {
    return <IconTypography {...props} />;
};

export const IconGlobeSVG = (props) => {
    return <IconGlobe {...props} />;
};

export const IconChevronSVG = (props) => {
    return <IconChevron {...props} />;
};

export const IconSearchSVG = (props) => {
    return <IconSearch {...props} />;
};

export const IconDeviceDesktopSVG = (props) => {
    return <IconDeviceDesktop {...props} />;
};

export const IconDeviceTabletSVG = (props) => {
    return <IconDeviceTablet {...props} />;
};

export const IconDeviceMobileSVG = (props) => {
    return <IconDeviceMobile {...props} />;
};

export const IconInfoSVG = (props) => {
    return <IconInfo {...props} />;
};

export const IconInfoGraySVG = (props) => {
    return <IconInfoGray {...props} />;
};

export const IconInfoYellowSVG = (props) => {
    return <IconInfoYellow {...props} />;
};

export const IconDocsSVG = (props) => {
    return <IconDocs {...props} />;
};

export const IconSupportSVG = (props) => {
    return <IconSupport {...props} />;
};

export const IconCopySVG = (props) => {
    return <IconCopy {...props} />;
};

export const IconCheckSVG = (props) => {
    return <IconCheck {...props} />;
};

export const IconCheckCircleSVG = (props) => {
    return <IconCheckCircle {...props} />;
};

export const IconTimesSVG = (props) => {
    return <IconTimes {...props} />;
};

export const IconLoveSVG = (props) => {
    return <IconLove {...props} />;
};

export const IconLayoutsSVG = (props) => {
    return <IconLayouts {...props} />;
};

export const IconBlocksSVG = (props) => {
    return <IconBlocks {...props} />;
};

export const IconToolbarColumnAddSVG = (props) => {
    return <IconToolbarColumnAdd {...props} />;
};

export const IconToolbarColumnDeleteSVG = (props) => {
    return <IconToolbarColumnDelete {...props} />;
};

export const IconFontSVG = (props) => {
    return <IconFont {...props} />;
};

export const IconDownload2SVG = (props) => {
    return <IconDownload {...props} />;
};

export const IconColumnSVG = (props) => {
...
export const IconDownloadSVG = ({ size = 16, ...props }) => {
    return <svg {...props} width={size} height={size} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        <path fillRule="evenodd" clipRule="evenodd" d="M11.957 6h.05a2.99 2.99 0 0 1 2.116.879 3.003 3.003 0 0 1 0 4.242 2.99 2.99 0 0 1-2.117.879v-1a2.002 2.002 0 0 0 0-4h-.914l-.123-.857a2.49 2.49 0 0 0-2.126-2.122A2.478 2.478 0 0 0 6.231 5.5l-.333.762-.809-.189A2.49 2.49 0 0 0 4.523 6c-.662 0-1.297.263-1.764.732A2.503 2.503 0 0 0 4.523 11h.498v1h-.498a3.486 3.486 0 0 1-2.628-1.16 3.502 3.502 0 0 1 1.958-5.78 3.462 3.462 0 0 1 1.468.04 3.486 3.486 0 0 1 3.657-2.06A3.479 3.479 0 0 1 11.957 6zm-5.25 5.121l1.314 1.314V7h.994v5.4l1.278-1.279.707.707-2.146 2.147h-.708L6 11.829l.707-.708z" />
    </svg>;
};
...
export const IconArrowLeftSVG = ({ size = 16, ...props }) => {
    return <svg {...props} width={size} height={size} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        <path fillRule="evenodd" clipRule="evenodd" d="M7 3.093l-5 5V8.8l5 5 .707-.707-4.146-4.147H14v-1H3.56L7.708 3.8 7 3.093z" />
    </svg>;
};

export const IconEmptySVG = ({ size = 25, ...props }) => {
    return <svg {...props} width={size} height={size} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
...
export const IconFullwidthSVG = ({ size = 120, ...props }) => {
    return <svg width={size} height={size} {...props} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="0.5" y="12.5" width="119" height="11" stroke="#5077F7" />
        <path d="M0.5 108.5H119.5V114C119.5 117.038 117.038 119.5 114 119.5H6C2.96244 119.5 0.5 117.038 0.5 114V108.5Z" fill="#F5F5F7" stroke="#5077F7" />
...
export const IconNotFoundSVG = () => {
    return <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_3312_159)">
            ...
            <path d="M62 16H2C0.896 16 0 15.104 0 14C0 12.896 0.896 12 2 12H62C63.104 12 64 12.896 64 14C64 15.104 63.104 16 62 16Z" fill="#A2A5A9" />
        </g>
        <defs>
            <clipPath id="clip0_3312_159">
...
export const IconSettingsNews = ({ color = '#99A2A9' }) => <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    ;
export const IconSettingsForm = ({ color = '#99A2A9' }) => <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_22933_14834)">
        <rect width="24" height="24" rx="12" fill={color} />
        <path d="M16.7993 18.0602H7.19971V5.69987H16.7993V18.0602ZM8.3999 15.1803V16.86H11.9995V15.1803H8.3999ZM8.3999 13.9801H15.6001V12.4206H8.3999V13.9801ZM8.3999 11.2204H15.6001V9.66081H8.3999V11.2204ZM8.3999 8.45963H11.6401V6.90006H8.3999V8.45963ZM12.3599 8.45963H15.5991V6.90006H12.3599V8.45963Z" fill="white" />
    </g>
    <defs>
        <clipPath id="clip0_22933_14834">
...
export const IconColumnAlignItemsCenter = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9.375 11.25V15H8.25V11.25H3V6.75H8.25V3H9.375V6.75H14.625V11.25H9.375Z" fill="currentColor" />
    </svg>;
};

export const IconColumnAlignItemsEnd = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11.25 6.75L11.25 11.25L3 11.25L3 6.75L11.25 6.75ZM15 15L13.875 15L13.875 3L15 3L15 15Z" fill="currentColor" />
    </svg>;
};

export const IconColumnAlignItemsStart = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.75 6.75L6.75 11.25L15 11.25L15 6.75L6.75 6.75ZM3 15H4.125L4.125 3H3L3 15Z" fill="currentColor" />
    </svg>;
};

export const IconColumnAlignItemsStretch = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M15 15L13.875 15L13.875 3L15 3L15 15ZM12.75 10.5L5.25 10.5L5.25 7.5L12.75 7.5L12.75 10.5ZM3 15L4.125 15L4.125 3L3 3L3 15Z" fill="currentColor" />
    </svg>;
};


export const IconColumnJustifyContentCenter = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.75 9.375L3 9.375L3 8.25L6.75 8.25L6.75 3L11.25 3L11.25 8.25L15 8.25L15 9.375L11.25 9.375L11.25 14.625L6.75 14.625L6.75 9.375Z" fill="currentColor" />
    </svg>;
};

export const IconColumnJustifyContentEnd = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.75 3L6.75 11.25L11.25 11.25L11.25 3L6.75 3ZM15 13.875L3 13.875L3 15L15 15L15 13.875Z" fill="currentColor" />
    </svg>;
};

export const IconColumnJustifySpaceAround = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.75 6.75L6.75 11.25L11.25 11.25L11.25 6.75L6.75 6.75ZM3 3L3 4.125L15 4.125L15 3L3 3ZM15 13.875L3 13.875L3 15L15 15L15 13.875Z" fill="currentColor" />
    </svg>;
};

export const IconColumnJustifySpaceBetween = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M15 3L15 4.125L3 4.125L3 3L15 3ZM10.5 5.25L10.5 12.75L7.5 12.75L7.5 5.25L10.5 5.25ZM15 15L15 13.875L3 13.875L3 15L15 15Z" fill="currentColor" />
    </svg>;
};

export const IconColumnJustifySpaceEvently = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M5.84961 8.07699H12.8496V6.09761H5.84961V8.07699Z" fill="currentColor" />
        <path d="M5.84961 12.0358H12.8496V10.0564H5.84961V12.0358Z" fill="currentColor" />
        <path d="M3.34961 3L3.34961 4.1134L15.3496 4.1134V3L3.34961 3Z" fill="currentColor" />
        <path d="M3.34961 13.8866L3.34961 15L15.3496 15V13.8866L3.34961 13.8866Z" fill="currentColor" />
    </svg>;
};

export const IconColumnJustifyStart = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11.25 6.75L6.75 6.75L6.75 15L11.25 15L11.25 6.75ZM3 3L3 4.125L15 4.125L15 3L3 3Z" fill="currentColor" />
    </svg>;
};
...
export const IconJustifyContentCenter = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9.375 11.25V15H8.25V11.25H3V6.75H8.25V3H9.375V6.75H14.625V11.25H9.375Z" fill="currentColor" />
    </svg>;
};

export const IconJustifyContentEnd = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M3 11.25H11.25V6.75H3V11.25ZM13.875 3V15H15V3H13.875Z" fill="currentColor" />
    </svg>;
};

export const IconJustifyContentSpaceAround = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.75 11.25H11.25V6.75H6.75V11.25ZM3 15H4.125V3H3V15ZM13.875 3V15H15V3H13.875Z" fill="currentColor" />
    </svg>;
};

export const IconJustifyContentSpaceBetween = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M3 3H4.125V15H3V3ZM5.25 7.5H12.75V10.5H5.25V7.5ZM15 3H13.875V15H15V3Z" fill="currentColor" />
    </svg>;
};

export const IconJustifyContentSpaceEvenly = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9.375 11.25V15H8.25V11.25H3V6.75H8.25V3H9.375V6.75H14.625V11.25H9.375Z" fill="currentColor" />
    </svg>;
};

export const IconJustifyContentStart = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.75 6.75V11.25H15V6.75H6.75ZM3 15H4.125V3H3V15Z" fill="currentColor" />
    </svg>;
};

export const IconAlignContentEnd = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.75 3L6.75 11.25L11.25 11.25L11.25 3L6.75 3ZM15 13.875L3 13.875L3 15L15 15L15 13.875Z" fill="currentColor" />
    </svg>;
};

export const IconAlignContentMiddle = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.75 9.375L3 9.375L3 8.25L6.75 8.25L6.75 3L11.25 3L11.25 8.25L15 8.25L15 9.375L11.25 9.375L11.25 14.625L6.75 14.625L6.75 9.375Z" fill="currentColor" />
    </svg>;
};

export const IconAlignContentSpaceAround = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.75 6.75L6.75 11.25L11.25 11.25L11.25 6.75L6.75 6.75ZM3 3L3 4.125L15 4.125L15 3L3 3ZM15 13.875L3 13.875L3 15L15 15L15 13.875Z" fill="currentColor" />
    </svg>;
};

export const IconAlignContentSpaceBetween = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M15 3L15 4.125L3 4.125L3 3L15 3ZM10.5 5.25L10.5 12.75L7.5 12.75L7.5 5.25L10.5 5.25ZM15 15L15 13.875L3 13.875L3 15L15 15Z" fill="currentColor" />
    </svg>;
};

export const IconAlignContentSpaceEvenly = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M6.75 9.375L3 9.375L3 8.25L6.75 8.25L6.75 3L11.25 3L11.25 8.25L15 8.25L15 9.375L11.25 9.375L11.25 14.625L6.75 14.625L6.75 9.375Z" fill="currentColor" />
    </svg>;
};

export const IconAlignContentStart = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11.25 6.75L6.75 6.75L6.75 15L11.25 15L11.25 6.75ZM3 3L3 4.125L15 4.125L15 3L3 3Z" fill="currentColor" />
    </svg>;
};

export const IconAlignItemsCenter = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const IconAlignItemsEnd = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11.25 11.25L6.75 11.25L6.75 3L11.25 3L11.25 11.25ZM3 15L3 13.875L15 13.875L15 15L3 15Z" fill="currentColor" />
    </svg>;
};

export const IconAlignItemsStart = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11.25 6.75L6.75 6.75L6.75 15L11.25 15L11.25 6.75ZM3 3L3 4.125L15 4.125L15 3L3 3Z" fill="currentColor" />
    </svg>;
};

export const IconAlignItemsStretch = () => {
    return <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M3 15L3 13.875L15 13.875L15 15L3 15ZM7.5 12.75L7.5 5.25L10.5 5.25L10.5 12.75L7.5 12.75ZM3 3L3 4.125L15 4.125L15 3L3 3Z" fill="currentColor" />
    </svg>;
};

export const IconSettingsIntegrations = ({ color = '#99A2A9' }) => <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
    <path d="M7.80667 5.63631C8.44792 5.68581 9.06892 5.87931 9.62805 6.20219C10.186 6.52394 10.6675 6.96494 11.0422 7.49369L9.20842 8.79531C9.02282 8.53265 8.78305 8.31284 8.5053 8.15069C8.24122 7.99687 7.94574 7.90483 7.64103 7.88145C7.33631 7.85807 7.03026 7.90396 6.7458 8.01569C6.45892 8.12931 6.19455 8.30819 5.96955 8.54331L4.0008 10.6223C3.60142 11.0622 3.3708 11.6618 3.37642 12.2941C3.38205 12.9286 3.62392 13.5248 4.03342 13.9568C4.44067 14.3877 4.97955 14.6206 5.52967 14.6251C5.80929 14.6258 6.08619 14.5702 6.34385 14.4616C6.6015 14.353 6.83463 14.1935 7.0293 13.9928L7.3758 13.6272C7.58224 13.4162 7.86334 13.2948 8.15846 13.2892C8.45359 13.2836 8.7391 13.3942 8.95343 13.5971C9.16776 13.8001 9.29373 14.0792 9.30419 14.3742C9.31464 14.6692 9.20873 14.9564 9.0093 15.1741L8.65492 15.5476L8.64142 15.5622C8.23461 15.9809 7.74736 16.313 7.20895 16.5386C6.67053 16.7642 6.09206 16.8787 5.5083 16.8751C4.92469 16.8673 4.34864 16.7419 3.81457 16.5065C3.28049 16.2711 2.79936 15.9304 2.39992 15.5048C1.58706 14.6393 1.13171 13.4983 1.1253 12.3109C1.1119 11.1239 1.54794 9.97571 2.34592 9.09681L2.35942 9.08219L4.33717 6.99531C4.7799 6.5258 5.32075 6.15972 5.92117 5.92319C6.52014 5.68718 7.16468 5.58838 7.80667 5.63631Z" fill={color} />
    <path d="M12.4934 1.12506C13.0768 1.133 13.6527 1.25842 14.1866 1.49385C14.7204 1.72928 15.2014 2.06988 15.6007 2.49531C16.4135 3.36084 16.8689 4.50182 16.8753 5.68919C16.889 6.87661 16.4529 8.02525 15.6547 8.90444L15.6412 8.91906L13.6634 11.0048C13.2207 11.4743 12.6798 11.8404 12.0794 12.0769C11.4805 12.3127 10.8361 12.4101 10.1942 12.362C9.55235 12.3139 8.92965 12.1214 8.37255 11.7991C7.81374 11.4744 7.33143 11.0331 6.95842 10.5053L8.79217 9.20481C8.98342 9.47481 9.22642 9.69306 9.49642 9.84944C9.76007 10.0039 10.0554 10.0963 10.36 10.1197C10.6647 10.143 10.9707 10.0968 11.2548 9.98444C11.5417 9.87194 11.806 9.69194 12.031 9.45681L14.0009 7.37894C14.4003 6.93906 14.6309 6.33944 14.6253 5.70719C14.6239 5.08924 14.3892 4.4946 13.9683 4.04219C13.7766 3.83607 13.5453 3.67074 13.2882 3.55611C13.0311 3.44148 12.7535 3.3799 12.472 3.37506C12.1921 3.37445 11.9149 3.43032 11.657 3.53935C11.3991 3.64837 11.1659 3.8083 10.9713 4.00956L10.6192 4.37856C10.4116 4.58715 10.1306 4.70613 9.83642 4.70999C9.5422 4.71385 9.25818 4.60228 9.04524 4.39921C8.83231 4.19613 8.70741 3.91771 8.69733 3.62364C8.68724 3.32957 8.79278 3.04325 8.9913 2.82606L9.35017 2.45031L9.36142 2.43906C9.76788 2.02045 10.2547 1.68827 10.7927 1.46247C11.3307 1.23668 11.91 1.12191 12.4934 1.12506Z" fill={color} />
</svg>;