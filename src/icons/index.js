...
export const IconKeySVG = ({fill='white', transform = 'translate(0,3)'}) => {
    return <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" transform={transform} fill={fill}>
