...
export const IconCloseSVG = ({ size = 16, ...props }) => {
    return <svg {...props} width={size} height={size} viewBox="0 0 13 13" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
...
export const IconHighlightSVG = ({ size = 16 }) => {
    return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4.92099 22.0006C4.65775 21.8017 4.63376 21.6841 4.80246 21.3926C5.31937 20.4995 5.83687 19.6067 6.35497 18.7142C6.38061 18.67 6.40915 18.6275 6.44393 18.5721L9.29492 20.2311C8.95365 20.7798 8.62334 21.315 8.28701 21.8463C8.24764 21.9085 8.17506 21.9497 8.11787 22.0006H4.92099Z" fill="black"/>
        <path d="M14.536 15.1951L8.29232 11.5731C8.33303 11.5032 8.36537 11.4422 8.40267 11.3844C10.1517 8.67438 11.9011 5.9646 13.6509 3.25509C14.4472 2.02269 15.8234 1.69191 17.0938 2.4244C17.4535 2.63181 17.8136 2.83862 18.1702 3.05126C19.2998 3.72476 19.691 5.01292 19.1002 6.1866C17.6074 9.1526 16.1087 12.1156 14.6041 15.0757C14.5869 15.1098 14.5663 15.1421 14.536 15.1951ZM10.4434 10.9227C10.624 10.9129 10.709 10.7831 10.7936 10.6484C12.2119 8.38916 13.6307 6.1302 15.0499 3.87152C15.2281 3.58774 15.2218 3.39636 15.0313 3.27411C14.8431 3.15337 14.6613 3.23286 14.4859 3.51258C13.0709 5.76628 11.6562 8.02011 10.2417 10.2741C10.1935 10.3433 10.1537 10.4179 10.1231 10.4965C10.1076 10.5462 10.1041 10.5989 10.113 10.6502C10.1218 10.7015 10.1428 10.75 10.1741 10.7916C10.2053 10.8333 10.2461 10.8669 10.2929 10.8897C10.3397 10.9124 10.3913 10.9238 10.4434 10.9227Z" fill="black"/>
        <path d="M14.2399 15.7953C13.9013 16.3832 13.5771 16.9515 13.2467 17.5162C13.1668 17.6528 13.0237 17.7292 12.88 17.6643C12.3815 17.4394 11.9827 17.6669 11.5964 17.9298C11.056 18.2975 10.6497 18.7947 10.3029 19.3419C9.99754 19.8236 9.95364 19.8378 9.46241 19.5529C8.62057 19.0646 7.77894 18.5759 6.93754 18.0868C6.64967 17.9194 6.6025 17.773 6.75939 17.4796C7.07363 16.8918 7.33415 16.2833 7.3939 15.6141C7.41938 15.3245 7.40291 15.0328 7.34501 14.7479C7.31183 14.5867 7.17483 14.4342 7.05384 14.307C6.89959 14.1448 6.84549 14.0134 6.95215 13.8235C7.26648 13.2638 7.58911 12.7089 7.9208 12.1306L14.2399 15.7953Z" fill="black"/>
    </svg>;
}