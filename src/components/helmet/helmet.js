...
import { TAG_NAMES, VALID_TAG_NAMES } from './helmet-constants';
import withSideEffect from './side-effect';
import { Component as ElementComponent, Children } from '@wordpress/element';

const Helmet = Component =>
    class HelmetWrapper extends ElementComponent {
        /**
                ...
                if (!VALID_TAG_NAMES.some(name => child.type === name)) {
                    ...
                    return warn(
                        `Only elements types ${VALID_TAG_NAMES.join(
                            ', '
                        )} are allowed. Helmet does not support rendering <${child.type
