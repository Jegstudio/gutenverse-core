...
const CardBannerPro = ({
    ...
    const card = <div className="form-pro-notice" style={customStyles}>
        ...
        <ButtonUpgradePro location="form-builder" link = {`${upgradeProUrl}?utm_source=gutenverse&utm_medium=formProNotice&utm_client_site=${clientUrl}&utm_client_theme=${activeTheme}`} isBanner={true} customStyles={{position: 'relative', padding: '8px 12px'}}/>
