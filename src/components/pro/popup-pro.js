            ...
            <div className="popup-pro">
                <div className="popup-content" ref={popupRef}>
                    ...
                    <div className="content">
                        ...
                        <ButtonUpgradePro location="popup" isBanner={true} onClick={() => setActive(false)} link={`${upgradeProUrl}?utm_source=gutenverse&utm_medium=dashboard&utm_client_site=${clientUrl}&utm_client_theme=${activeTheme}`} customStyles={{ height: '16px', padding: '12px 25px 12px 30px' }} licenseType={licenseType} />
                    </div>
                </div>
            </div>
        </>
