    ...
    useEffect(() => {
        ...
        if ( selectedItems.length > 0 && dynamicDataList.length === selectedItems.length) {
            ...
            selectedItems.map((item, index)=>{
                ...
                if (title !== content){
                    ( dynamicTextContent.then === 'function' ) && !isEmpty(dynamicDataList[index].dynamicContent) && dynamicTextContent
                        .then(result => {
                ...
                if (href !== '#') {
                    ...
                    ( dynamicUrlcontent.then === 'function' ) && !isEmpty(dynamicDataList[index].dynamicUrl) && dynamicUrlcontent
                        .then(result => {
