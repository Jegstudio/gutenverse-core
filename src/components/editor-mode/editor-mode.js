...
const gutenverseEditorModePlugin = registerPlugin('gutenverse-editor-mode', {
    render: () => {
        ...
        const editorModeButton = (
            <Tooltip
                placement="right"
                text={renderingMode === 'template-locked' ? __('This view is locked. Click to go into Content Editing.', '--gctd--') : __('You are currently in Content Editing. Click to go to Template View.', '--gctd--')}>
