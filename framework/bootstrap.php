...
defined( 'GUTENVERSE_FRAMEWORK_VERSION' ) || define( 'GUTENVERSE_FRAMEWORK_VERSION', '2.1.0' );
...
defined( 'GUTENVERSE_FRAMEWORK_AI_URL' ) || define( 'GUTENVERSE_FRAMEWORK_AI_URL', 'https://pro.gutenverse.com' );
