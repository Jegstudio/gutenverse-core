...
defined( 'GUTENVERSE_PRO_ACTIVATION_URL' ) || define( 'GUTENVERSE_PRO_ACTIVATION_URL', 'https://pro.gutenverse.com/' );
defined( 'GUTENVERSE_FRAMEWORK_REFERRAL_URL' ) || define( 'GUTENVERSE_FRAMEWORK_REFERRAL_URL', GUTENVERSE_PRO_ACTIVATION_URL . 'invite' );
